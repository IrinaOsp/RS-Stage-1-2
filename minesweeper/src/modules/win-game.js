...
export function winGamePopup() {
  ...
  GAME_OVER_TEXT.innerHTML = `Congratulations! You've found all upside down portals in ${minutes > 0 ? minutes + ' minutes' : ''} ${seconds > 0 ? seconds + ' seconds' : ''}  and ${clicksNum} moves!`;
